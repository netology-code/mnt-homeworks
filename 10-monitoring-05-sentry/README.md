...
Так как self-hosted Sentry довольно требовательная к ресурсам система, мы будем использовать Free аккаунт.

Free account имеет следующие ограничения:
- 5 000 errors
- 10 000 transactions
- 1 GB attachments

В случае, если, у вас нет возможности выполнять задание на данной конфигурации - используйте cloud версию:
