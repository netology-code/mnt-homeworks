...
днс. кипалайв, нжинкс, скорость ответа, закрузка цпу, загрузка сети, загрузка диска, место на диске
...
сло, сла, сли, посчитать процент (95 перцентиль) выполнения запроса, кол-во клиетов в ед. времени,
...
применить елк, сентри - облачные бесплатные решения
...
посчитать формулу из слайда

## Дополнительное задание (со звездочкой*) - необязательно к выполнению

из /proc собрать данные и складывать в json 
